...
list($course, $coursemodule) = get_course_and_cm_from_cmid($coursemoduleid, 'write');

require_login($course, true, $coursemodule);

$title = get_string('modulename', 'mod_write');
$url = new moodle_url('/mod/write/view.php', ['id' => $coursemoduleid]);
...
$PAGE->requires->js_call_amd('mod_write/app-lazy', 'init', [
